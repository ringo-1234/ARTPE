        ...
        try {
            ...
            if (listSelect != null && button.id >= 0 && button.id < listSelect.size()) {
                ...
                if (this.selector != null) {
                    ...
                    if (this.selector instanceof jp.apple.tileentity.TileEntityTrainPlacer) {
                        jp.apple.tileentity.TileEntityTrainPlacer te = (jp.apple.tileentity.TileEntityTrainPlacer) this.selector;
